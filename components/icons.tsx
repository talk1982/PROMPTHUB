...
export const PromptHubLogoIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg {...props} viewBox="0 0 250 50" height="50">
        <style>
            {`.ph-logo-text { font-family: "Arial", sans-serif; font-size: 38px; font-weight: bold; }`}
        </style>
        <text x="5" y="38" className="ph-logo-text" fill="currentColor">
            Prompt
        </text>
        <rect x="150" y="5" width="90" height="40" rx="8" ry="8" fill="#38BDF8" />
        <text x="159" y="38" className="ph-logo-text" fill="#1E293B">
            Hub
        </text>
    </svg>
);
...
export const BotIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <Icon {...props}><path strokeLinecap="round" strokeLinejoin="round" d="M8.25 7.5l.415-.207a.75.75 0 011.085.67V10.5m0 0h6m-6 0a.75.75 0 001.085.67l.415-.207M12 15.75V12m0 3.75a.75.75 0 01-1.085-.67l-.415.207a.75.75 0 01-1.085-.67V10.5m0 0h-6m6 0a.75.75 0 00-1.085-.67l-.415.207M12 4.5V1.875a1.875 1.875 0 013.75 0V4.5m-3.75 0h3.75M12 4.5v3.75m-3.75 0h3.75M12 15.75v3.75a1.875 1.875 0 01-3.75 0V15.75m3.75 0h-3.75M12 21.75v-3.75m3.75 0h-3.75m-3.75 0h-3.75a1.875 1.875 0 01-1.875-1.875V12m1.875 0h3.75m0 0V8.25m0 0a1.875 1.875 0 013.75 0v3.75m0 0h3.75a1.875 1.875 0 011.875 1.875v3.75m-1.875 0h-3.75m0 0V18m0 0a1.875 1.875 0 01-3.75 0v-3.75" /></Icon>
);
